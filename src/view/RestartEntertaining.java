...
public class RestartEntertaining extends JFrame{
    ...
    private JLabel jl;
    private Image image;
    public RestartEntertaining(int width, int height, EntertainingController controller, EntertainingPanel gamePanel, JFrame gameFrame, JFrame jFrame){
        setFocusable(true);
        try {
